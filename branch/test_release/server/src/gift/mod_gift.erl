...
%%    DbGivePlayer = mod_player:get_player(GivePlayerId),
...
%%            {PropId, floor((10000 - GiveawayFee) * PropNum / 10000)}
    ...
    3 = rpc:call(GiveNode, erlang, abs, [-3]),
    Tran =
        fun() ->
...
%%            mod_prop:decrease_player_prop(PlayerId, PropList, LogType),
%%            gift_mail:add_mail_template_item(GivePlayerId, GiftMailId, TitleParamList, ContentParamList, WeightValue, NewPropList, CurrTime)

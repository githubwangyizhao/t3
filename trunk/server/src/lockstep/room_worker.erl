...
handle_close_room() ->
	...
	_BattleHistoryTerm = {battle_history_info, [
	...
	_FileName = io_lib:format("../log/game/~s/~p~6.10.0B.battle", [lists:concat([YY, "_", MM, "_", DD]), util_time:milli_timestamp(), rand:uniform(999999)]),
%%	util_file:save_term(_FileName, _BattleHistoryTerm),

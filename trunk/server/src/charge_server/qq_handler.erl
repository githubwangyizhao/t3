...
%%                {1, result_msg(R1)}
%%        end,
%%    ErrorList = [{code, ErrorCode}, {msg, Msg}],
...
%%
%%%% @doc     qq小游戏平台充值
%%path_request(<<"/charge_qq_game">>, <<"POST">>, Ip, Req) ->
%%    {ParamList, ParamStr} = get_req_param_str(Req),
%%    ?INFO("qq小游戏平台充值:~p ~n", [ParamStr]),
...
%%        _ ->
%%            mod_charge_server:server_charge("", OrderId, Money, PlatformServerOrderIdStr, Ip, util_time:timestamp(), ?CHANNEL_QQ_GAME)
%%    end;

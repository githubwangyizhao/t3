...
sed -i 's#.*template_dir.*#    {template_dir, "../../table/csv"},#g' ${TOOL_CONFIG}

START_SH=${TARGET_PATH}/script/start.sh
sed -i 's#.*-name.*#-name 't3_release@192.168.31.100' \\#g' ${START_SH}
#create_tool_config

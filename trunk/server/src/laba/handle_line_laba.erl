...
%%                                ?DEBUG("第~p回合不中！", [TotalFreeGameTimes - LeftTimes + 1]),
                        ...
                        %% 初始预埋路线
                            true ->
                                ?DEBUG("Id ~p, ThisExpectRewardNum ~p, CoinsBet ~p, Val ~p, PreSetLineIdList ~w", [FreeGameLaBaId, ThisExpectRewardNum, CoinsBet, floor(ThisExpectRewardNum / CoinsBet * 10000), PreSetLineIdList]),
